...
export default function Home() {
  ...
  useEffect(() => {
    fetch("/api/transactions?quantity=1")
      ...
      .finally(() => setIsLoading(false)); // Set loading to false when the fetch is complete
  }, []);
    ...
    >
      ...
      <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
        {isLoading ? (
          ...
          <StatsCollection
            data={Object.entries(results?.amountsByCardType).slice(0,3).map(([cardType, amount]) => ({
              label: cardType,
